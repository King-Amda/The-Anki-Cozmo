...
from AnkiCozmo import DRAGONS as SUDO_USERS
from AnkiCozmo import pbot
from AnkiCozmo.modules.sql import forceSubscribe_sql as sql
...
❂ Anki Cozmo can mute members who are not subscribed your channel until they subscribe
