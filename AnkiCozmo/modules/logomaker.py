from AnkiCozmo.events import register
from AnkiCozmo import OWNER_ID
from AnkiCozmo import telethn as tbot
import os 
...
async def lego(event):
 ...
 try:
    ...
    img = Image.open('./AnkiCozmo/resources/blackbg.jpg')
    draw = ImageDraw.Draw(img)
    image_widthz, image_heightz = img.size
    pointsize = 500
    fillcolor = "gold"
    shadowcolor = "blue"
    font = ImageFont.truetype("./AnkiCozmo/resources/Chopsic.otf", 330)
    ...
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By @TheAnkiCozmoBot ⚡️")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Go to Help From  @TheAnkiCozmoSupport, {e}')
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "gold"
    shadowcolor = "blue"
    font = ImageFont.truetype("./AnkiCozmo/resources/Chopsic.otf", 950)
    w, h = draw.textsize(text, font=font)
    h += int(h*0.21)
    image_width, image_height = img.size
    draw.text(((image_widthz-w)/2, (image_heightz-h)/2), text, font=font, fill=(255, 255, 255))
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "white"
    shadowcolor = "blue"
    font = ImageFont.truetype("./AnkiCozmo/resources/Maghrib.ttf", 1000)
    w, h = draw.textsize(text, font=font)
    h += int(h*0.21)
    image_width, image_height = img.size
    draw.text(((image_widthz-w)/2, (image_heightz-h)/2), text, font=font, fill=(255, 255, 255))
    ...
    fname2 = "AnkiVectorLogo.png"
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By @TheAnkiCozmoBot")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Go to Help From  @TheAnkiCozmoSupport, {e}')
...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        fpath_ = glob.glob("AnkiCozmo/resources/*")
    ...
    if os.path.exists(font_):
        if not font_.startswith("AnkiCozmo/resources/"):
            os.remove(font_)    
...
async def lego(event):
 ...
 try:
    text = event.pattern_match.group(1)
    img = Image.open('./AnkiCozmoresources/blackbg.jpg')
    draw = ImageDraw.Draw(img)
    image_widthz, image_heightz = img.size
    pointsize = 500
    fillcolor = "gold"
...
async def lego(event):
 ...
 try:
    text = event.pattern_match.group(1)
    img = Image.open('./AnkiCozmo/resources/pandabg.png')
    draw = ImageDraw.Draw(img)
    image_widthz, image_heightz = img.size
    pointsize = 25
    fillcolor = "gold"
    shadowcolor = "blue"
    font = ImageFont.truetype("./AnkiCozmo/resources/font.otf", 170)
    w, h = draw.textsize(text, font=font)
    h += int(h*0.21)
    image_width, image_height = img.size
    draw.text(((image_widthz-w)/2, (image_heightz-h)/2), text, font=font, fill=(255, 255, 255))
...
async def lego(event):
 ...
 try:
    text = event.pattern_match.group(1)
    img = Image.open('./AnkiCozmo/resources/spiderbg.png')
    draw = ImageDraw.Draw(img)
    image_widthz, image_heightz = img.size
    pointsize = 25
    fillcolor = "gold"
...
async def lego(event):
 ...
 try:
    text = event.pattern_match.group(1)
    img = Image.open('./AnkiCozmo/resources/spiderbg (2).png')
    draw = ImageDraw.Draw(img)
    image_widthz, image_heightz = img.size
    pointsize = 25
    fillcolor = "gold"
