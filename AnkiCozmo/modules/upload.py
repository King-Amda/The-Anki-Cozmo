...
from AnkiCozmo import telethn as bot
from AnkiCozmo.modules.urluploader import download_file
from AnkiCozmo.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @TheAnkiCozmoBot",
            )
        except Exception as e:
            traceback.print_exc()
