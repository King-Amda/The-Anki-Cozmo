...
from AnkiCozmo.modules import ALL_MODULES
from AnkiCozmo.modules.helper_funcs.alternate import typing_action
from AnkiCozmo.modules.helper_funcs.chat_status import is_user_admin
from AnkiCozmo.modules.helper_funcs.misc import paginate_modules
from AnkiCozmo.modules.helper_funcs.readable_time import get_readable_time

PM_START_TEXT = """
𝑯𝒆𝒍𝒍𝒐 𝑻𝒉𝒆𝒓𝒆, 𝑰'𝒎 [𝑨𝒏𝒌𝒊 𝑪𝒐𝒛𝒎𝒐](t.me/TheAnkiCozmoBot) 👽
𝑨 𝑻𝒆𝒍𝒆𝒈𝒓𝒂𝒎 𝑮𝒓𝒐𝒖𝒑 𝑴𝒂𝒏𝒂𝒈𝒆𝒎𝒆𝒏𝒕 𝑩𝒐𝒕 .. 
𝑴𝒂𝒅𝒆 𝑩𝒚 [𝑲𝒊𝒏𝒈 𝑨𝒎𝒅𝒂](t.me/NiupunDinujaya)
𝑯𝒊𝒕 /help 𝑻𝒐 𝑭𝒊𝒏𝒅 𝑴𝒚 𝑳𝒊𝒔𝒕 𝑶𝒇 𝑨𝒗𝒂𝒊𝒍𝒂𝒃𝒍𝒆 𝑪𝒐𝒎𝒎𝒂𝒏𝒅𝒔
 
"""

buttons = [
    [
        InlineKeyboardButton(text="📌ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ", url="https://t.me/TheAnkiCozmoUpdates"),
        InlineKeyboardButton(text="🖲 ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ", url="https://t.me/TheAnkiCozmoSupport"),
    ],
    [
        InlineKeyboardButton(text="📜 ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url="https://github.com/King-Amda"),
        InlineKeyboardButton(text="❔ ʜᴇʟᴘ", url="http://t.me/TheAnkiCozmoBot?start=help"),
    ],
    [
        InlineKeyboardButton(
...
ANKICOZMO_IMG = "https://telegra.ph/file/f3b11d850d065ab3053fd.jpg"

HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/f3b11d850d065ab3053fd.jpg)
...
Support them  [King Amda](t.me/NiupunDinujaya)"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("AnkiCozmo.modules." + module_name)
...
def AnkiVector_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by King Amda.* "
            f"\n\n Contact [KingAmda](https://t.me/NiupunDinujaya) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Anki Cozmo Support ](https://t.me/TheAnkiCozmoSupport).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [Anki Cozmo Brother](http://t.me/AnkiVectorBot)."
        ...
        query.message.edit_text(
            ...
            f"\n✪ Always try to keep credits, so \n  This hardwork is done by Anki Cozmo Updates team spending many sleepless nights.. So, Respect it."
